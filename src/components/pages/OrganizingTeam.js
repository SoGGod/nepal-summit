    ...
    return (
        <div className="oteam">
            ...
            <div className="content mt-4">
                <div className="detail mb-1">
                <h3>Mrs. Lorem Ipsum<br /><span>Lorem</span></h3>
                <ul className="sci mb-2">
                    <li>
