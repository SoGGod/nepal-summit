        ...
        <div className="program">
            ...
            <div className="program_down col-md-4 w-100">
             ...
             <h4 id="schedule_h4" style={{textAlign:'center'}}>Program Schedules</h4>
                 <img className="schedule_image w-100" style={{marginTop:'-60px',justifyContent:'center'}} src="https://www.pngkey.com/png/detail/14-140024_4-arrows-right-arrow-gif-transparent-background.png"/>
             </div>
